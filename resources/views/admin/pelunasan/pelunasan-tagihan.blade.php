...
<ul class="nav nav-tabs my-3" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="profile-tab" data-bs-toggle="tab" data-bs-target="#tata-cara-pane"
            type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Tata Cara
            Pembayaran</button>
    </li>
    <li class="nav-item" role="presentation">
        ...
        <form action="{{ route('pelunasan.lunasi', $tagihan->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="upload-area border border-dashed p-4 text-center bg-light">
                    ...
                    <p>Drag & drop files or <a href="javascript:void(0)" class="text-primary"
                            onclick="document.getElementById('selectImage').click()">Browse</a></p>
